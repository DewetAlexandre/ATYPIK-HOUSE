...
<div class="dblock px-8 mx-auto rounded-lg shadow-lg p-4 m-32">
            <form action="/auth/newMdp" method="get">
                ...
                <div class="flex flex-wrap mx-6 mb-2">
                    ...
                    <div class="w-full px-3 mb-2 md:mb-0 ">
                        ...
                        <input
                            ...
                            id="destination" type="text" placeholder="Ton Adresse Mail" name="email">
                    </div>
                    @if(session()->has('errorEmail'))
                    <p class="text-red-500">L'email rechercher n'existe pas !</p>
                    @endif
                </div>
